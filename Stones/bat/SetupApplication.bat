...
:: Android packaging
set AND_CERT_NAME="Stones"
set AND_CERT_PASS=GDTpass
set AND_CERT_FILE=cert\GDT.p12
...
set IOS_PROVISION=cert\Stones.mobileprovision
...
set APP_ID=air.Stones

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Stones
