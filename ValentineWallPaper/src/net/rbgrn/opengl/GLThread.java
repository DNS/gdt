...
class GLThread extends Thread {
	...
	private final Valentine mRenderer;
	...
	GLThread(final Valentine renderer, final EGLConfigChooser chooser, final EGLContextFactory contextFactory, final EGLWindowSurfaceFactory surfaceFactory, final GLWrapper wrapper) {
		super();
		this.mDone = false;
		this.mWidth = 0;
		this.mHeight = 0;
	...
	public void onTouch(int x, int y) {
		this.mRenderer.onTouchEvent(x, y);
	}
	
	public void onOffsetsChanged(float x, float xStep){
		this.mRenderer.onOffsetsChanged(x, xStep);
	}
